...
The plot below shows how scoring (the x-axis value) relates to the expected probability of a team winning (the y-axis value). If you hover over the blue line, you will see the score and corresponding probability of winning.

For example, if a team scores 21.5 points, that would give them almost a 50% chance of winning, whereas scoring a little over 11 points would give a team almost a 10% probability of winning, and scoring 31.8 points would give a team a probability of winning of a little over 90%.
...
As a way of further exploring the importance of line breaks to scoring, it is worth investigating the relationship between line breaks, try assists and try scoring. 

Given the limitations of the rugby league box score-style data that has been scrapped, filtering methods for player data has been used to estimate numbers of try assists via kicks, unassisted line breaks, and unassisted tries.

## Methodology

### Unassisted tries
An unassisted try was estimated where there were more `Team Tries` than `Team Try Assists` for a Team in a given game. For every additional `Team Try` an Unassisted Try was credited.

### Kick Assist
The most accurate way of calculating a Potential Kick Assist was filtering for players who kicked the ball in a given game, and had more Try Assists than LineBreak Assists in the same game. For every additional `Team Try` an Unassisted Try was credited.
